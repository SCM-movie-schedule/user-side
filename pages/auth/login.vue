...
onDone((result) => {
  ...
  authStore.setUserId(result.data.login.id);
...
<template>
  <div class="login pt-24">
    <base-dialog
      :show="someThingWrong"
      @close="someThingWrong = false"
      title="Some thing Went Wrong"
    ></base-dialog>
    <div
      id="detail-header-container"
      class="auth bg-red md:bg-primary3 bg-no-repeat bg-cover bg-center relative md:pt-12"
      style=""
    >
      <div
        class="back absolute bg-gradient-to-l from-orange-600 to-orange opacity-75 inset-0 z-1"
      ></div>
      <div
        class="md:min-h-screen sm:flex sm:flex-row lg:space-x-20 mx-0 justify-center"
      >
        <div
          class="flex-col sm:hidden lg:flex self-center sm:max-w-5xl xl:max-w-2xl z-10"
        >
        ...
        <div class="flex sm:w-full lg:w-auto justify-center self-center z-10">
          <div class="p-6 mx-auto md:rounded-3xl bg-white w-full max-w-[24rem]">
            <div class="mb-4">
            ...
            <div class="space-y-5">
              <Form
                @change="invalidCredential = false"
                class="space-y-5"
                @submit="handleLogin"
              ...
              >
                <div class="space-y-2 flex flex-col">
                  ...
                  <Field
                    ...
                    type="email"
                    class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:border-yellow-bright"
                ...
                <div class="space-y-2 flex flex-col">
                  ...
                  <Field
                    ...
                    type="password"
                    class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:border focus:border-yellow-bright focus:border-solid"
                ...
                <div class="flex items-center justify-between space-x-7">
                  <div class="flex items-center">
                    <input
                      ...
                      name="remember_me"
                      type="checkbox"
                      class="h-4 w-4 bg-blue-5 focus:ring-blue-400 border-gray-300 rounded"
                    />
                    <label
                      for="remember_me"
                ...
                <div class="flex justify-center">
                  <button
                    ...
                    type="submit"
                    :class="{
                      'bg-yellow-orange': loading,
                      'hover:bg-orange-00': loading,
                    }"
                    class="w-44 flex justify-center bg-yellow-bright opacity-80 hover:opacity-100 text-white p-3 rounded-full tracking-wide font-semibold shadow-lg cursor-pointer transition ease-in duration-400"
                  >
                    Sign in
                    <span
                      v-if="loading"
                      a
                      class="absolute animate-spin text-9xl inline-block w-8 h-8 border-[3px] border-current border-t-transparent text-white rounded-full"
                      role="status"
                      aria-label="loading"
                    ></span>
                  </button>
            ...
            <div class="pt-5 text-center text-gray-400 text-xs">
              <span>
                ...
                <a
                  ...
                  target="_blank"
                  title="Ajimon"
                  class="text-yellow-bright font-bold"
                  >Solflx</a
                ></span
              >
            </div>
