...
const { mutate, onDone, loading, onError } = authentication(
...
<template>
  <div class="pt-24 md:pt-0">
    ...
    <div
      ...
      class="auth md:bg-primary3 bg-no-repeat bg-cover bg-center relative"
    >
      <div
        class="back absolute bg-gradient-to-l from-orange-600 to-orange-400 opacity-75 inset-0 z-1"
      ></div>
      <div class="md:min-h-screen sm:flex sm:flex-row mx-0 justify-center">
        <div class="flex justify-center self-center w-full z-10">
          <div class="p-6 mx-auto bg-white md:rounded-3xl w-full max-w-[23rem]">
            <div class="mb-4">
                ...
                <div class="text-red" v-show="showEmailSentMessage">
                  <transition name="error">
                    <p class="w-full text-green">
                      We have sent email verify link to this email
                    </p>
                  </transition>
                </div>
